-- select * from tb_brinde

UPDATE 'tb_promsurpresaperiod'
        SET `ativo` = 'N' 
          WHERE `seqpromsurpresa` = '1' AND `dtahorinicio` = '2024-08-14 14:00:00' AND `dtahorfim` = '2024-08-14 18:00:00';

Select * from tb_promsurpresaperiodo x 
         where 
         --x.seqpromsurpresa >= 501 
         trunc(x.dtahorinicio) >= '04oct2025'
         order by x.dtahorinicio;
